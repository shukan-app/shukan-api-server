...
public final class MainTest {
	...
	@Test
	public void testParsePortDefaultsTo7070WhenBlank() {
		assertEquals(7070, Main.parsePort(""));
	}

	@Test
	public void testParsePortDefaultsTo7070WhenWhitespace() {
		assertEquals(7070, Main.parsePort("   "));
	}

	@Test
	public void testParsePortRejectsPortWithWhitespace() {
		assertThrows(IllegalStateException.class, () -> Main.parsePort("80 80"));
	}

	@Test
	public void testParsePortAcceptsPortZero() {
		assertEquals(0, Main.parsePort("0"));
	}

	@Test
	public void testParsePortAcceptsHighPort() {
		assertEquals(65535, Main.parsePort("65535"));
	}
